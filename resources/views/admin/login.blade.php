...
<head>
    ...
    <title>Admin Login — EINOVATECH</title>
...
<body class="h-full font-sans antialiased bg-slate-100 flex items-center justify-center">
    <div class="w-full max-w-md px-6">
        ...
        <div class="flex items-center justify-center mb-8">
            ...
            <div>
                <span class="text-2xl font-bold text-slate-900">EINOVATECH</span>
            ...
            <form method="POST" action="{{ route('admin.login.submit') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus
                           ...
                           placeholder="admin@einovatech.com">
                    @error('email')
        ...
        <p class="mt-6 text-center text-xs text-slate-400">&copy; {{ date('Y') }} EINOVATECH. All rights reserved.</p>
    </div>
</body>
</html>
